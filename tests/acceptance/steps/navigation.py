...
def step_impl(context):
    context.browser = webdriver.Chrome('C:\\Shwetha\\PythonTraining\\selenium-Section10\\code\\webdriver\\chromedriver.exe')
...
def step_impl(context):
    context.browser = webdriver.Chrome(
            'C:\\Shwetha\\PythonTraining\\selenium-Section10\\code\\webdriver\\chromedriver.exe')
